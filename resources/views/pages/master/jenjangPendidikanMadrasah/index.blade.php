...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ route('jenjangPendidikan.index') }}">Jenjang Pendidikan Madrasah</a>
    </li>
@endsection
        ...
        <div class="modal-content">
            ...
            <form id="addForm">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="nama" class="form-label">Jenjang Pendidikan<span style="color:red">*</span></label>
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan jenjang pendidikan" required>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Jenjang Pendidikan<span style="color:red">*</span></label>
                        <input type="text" class="form-control" id="edit_nama" name="edit_nama" placeholder="Masukkan jenjang pendidikan" required>
                    </div>
                </div>
...
<script>
    ...
    const _URL = "{{ route('jenjangPendidikan.getData') }}";
    ...
    $(document).ready(function () {
        ...
        $('#addForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('jenjangPendidikan.store') }}",
                type: "POST",
                data: $(this).serialize(),
        ...
        $('#editForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('jenjangPendidikan.update') }}",
                type: "POST",
                data: $(this).serialize(),
                success: function(response) {
                    Swal.fire({
    ...
    function deleteData(button) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ route('jenjangPendidikan.destroy') }}",
                    type: "POST",
                    data: {
                        id: data.id,
                        _token: "{{ csrf_token() }}",
